...
$(".allSubs").click(function(){
 ...
 $(".form-control, .allNotes, #print, #rs, .submit, #submit, #saveButton, .save, .rs, .print").attr('disabled', false);
...
$(".form-control, .allNotes, #print, #rs, .rs, .print, .submit, #submit, #saveButton, .save").attr('disabled', true);
return false;
