...
var gsNavPrev="<A href='javascript:void(0)' class='MonthNav' onclick='if(this.blur)this.blur();fPrevMonth();return false;' onmouseover='return true;'><IMG src='../images/arrowl.gif' width='6' height='10' border='0' alt=''></A>";	// the content of the left month navigator
var gsNavNext="<A href='javascript:void(0)' class='MonthNav' onclick='if(this.blur)this.blur();fNextMonth();return false;' onmouseover='return true;'><IMG src='../images/arrowr.gif' width='6' height='10' border='0' alt=''></A>";	// the content of the right month navigator
