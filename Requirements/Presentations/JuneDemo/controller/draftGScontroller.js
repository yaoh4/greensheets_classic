...
$(".submit").click(function(){
 ...
 $('html, body').animate({ scrollTop: 0 }, 0);
    ...
    $("#1, #8-1, #Textarea1,  #Textarea8, #12-2-1-1-1, #Textarea12-2-1-1-1, #12-2-1-1-2, #radio12-2-1-1-1, #sub12-2-1-1-3, #date, .warning1, #1-1text").removeClass("has-error");
    $(".warning1").attr('style', 'display: none');
    $("#success").attr("style", "display: block");
    $("#main1,  #main8, #main12, #sub12-2, #sub12-2-1, #sub12-2-1-1").removeClass("treetable-expanded");
     $("#main1,  #main8, #main12, #sub12-2, #sub12-2-1, #sub12-2-1-1" ).addClass("treetable-collapsed");
     $("#1sub,  #8sub, #sub12-2, #sub12-2-1, #sub12-2-1-1, #sub12-2-1-1-1, #sub12-2-1-1-2, #sub12-2-1-1-3, #sub12-2-2, #sub12-2-3, #sub12-2-4, #sub12-2-5, #sub12-2-6").attr('style','display: none');
 ...
 $(".allSubs").text("Exit Preview"); 
     $(".expanded").attr('style', 'display:table-row');
        ...
        $('tr').removeClass("treetable-collapsed");
         ...
         $(".print").attr( ('title', 'This is the hover-over text'));
...
$("#main1 span").css('cursor', 'not-allowed'); 
  ...
  else if ($(this).val() == 'Select an Option')
  {
       ...
       $( "#main1 span").removeClass( "fa-angle-double-down" );
$( "#main1 span").addClass( "fa-angle-double-right" );
