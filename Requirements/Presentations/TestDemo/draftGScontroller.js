...
//Expand All Function
 ...
 $(".form-control, .allNotes, #print, #rs, .submit, #submit, .form-check-input, .preview").attr('disabled', false);
...
$(".form-control, .allNotes, #print, #rs, .submit, #submit, .form-check-input, .preview").attr('disabled', true);
return false;
