...
//controller for Q3
   ...
   $('tr #main3').addClass("treetable-collapsed");
     $("#main3").find('span').addClass("fa-plus-circle");
      $("#main3").find('span').addClass("fa");
      $("#main3").find('span').removeClass("fa-minus-circle");
      $(".comments").removeClass("fa-plus-circle");
        $(".comments").removeClass("fa");

//controller for Q4
  
  
     $("#main4").find('span').addClass("fa-plus-circle");
...
//controller for Q12
     ...
     $("#main12").find('span').addClass("fa-plus-circle");
      $("#main12").find('span').addClass("fa");
      $("#main12").find('span').removeClass("fa-minus-circle");
      $("#sub12-2").find('.treetable-expander').addClass("fa-plus-circle");
       $("#12sub").find('.treetable-expander').addClass("fa-plus-circle");
...
//controller for Q12-2
     ...
     $("#sub12-2").find('span').addClass("fa-plus-circle");
     ...
     $("#sub12-2").find('.treetable-indent').removeClass("fa-minus-circle");
       $("#sub12-2").find('.treetable-indent').removeClass("fa-plus-circle");
      $("#sub12-2-1").find('.treetable-expander').addClass("fa-plus-circle");
   ...
   $('#3sub').addClass("expanded");
    $('#4sub').addClass("expanded");
     ...
     $('#12-1-1-1sub').addClass("expanded");
      ...
      $('#sub12-2-2').addClass("expanded");
      $('#sub12-2-3').addClass("expanded");
       $('#sub12-2-4').addClass("expanded");
        $('#sub12-2-5').addClass("expanded");
           $('#sub12-2-6').addClass("expanded");
           $('#sub12-2-6-1').addClass("expanded");
           $('#sub12-2-6-1-1').addClass("expanded");
      $('#sub12-2-3-1').addClass("expanded");
      $('#sub12-2-3-1-1').addClass("expanded");
...
//controller for Q3
 ...
 $("#3-1sub").attr("style", "display:none");
  ...
  //controller for Q3-1
  $("input[name$='optionsRadios3-1']").change(function(){
  var radio_value = $(this).val();
  if(radio_value=='Yes') {
   $("#3-1sub").attr("style", "display:none");
...
$('.panel-heading span.clickable2').addClass(panel)
