...
public class GreensheetGroupType extends ValuedEnum {
    ...
    public static final GreensheetGroupType PGM = new GreensheetGroupType("PGM", PGM_VALUE);
    public static final GreensheetGroupType SPEC = new GreensheetGroupType("SPEC", SPEC_VALUE);
    public static final GreensheetGroupType RMC = new GreensheetGroupType("RMC", RMC_VALUE);
