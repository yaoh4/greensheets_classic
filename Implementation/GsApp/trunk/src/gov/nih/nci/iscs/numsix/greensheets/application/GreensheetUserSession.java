...
public class GreensheetUserSession implements HttpSessionBindingListener {
   ...
   public GreensheetForm getGreensheetForm(String formSessionId){
        GreensheetForm g = ((GreensheetFormSession)greensheetFormSessions.get(formSessionId)).getForm();
        return g;
    }
    ...
    public GsGrant getFormSessionGrant(String formSessionId){
        GsGrant g = ((GreensheetFormSession)greensheetFormSessions.get(formSessionId)).getGrant();
        return g;
    }
     ...
     * @param paylineOnly The paylineOnly to set
     */
    ...
    public void valueBound(HttpSessionBindingEvent be) {
         ...
         logger.debug("User Session Bound:: user " + this.user.getRemoteUserName() + "  sessionId " + be.getSession().getId());
    ...
    public void valueUnbound(HttpSessionBindingEvent be) {
        ...
        logger.debug("User Session Unbound:: user " + this.user.getRemoteUserName() + "  sessionId " + be.getSession().getId());
    }
     ...
     * @param myPortfolio The myPortfolio to set
     */
