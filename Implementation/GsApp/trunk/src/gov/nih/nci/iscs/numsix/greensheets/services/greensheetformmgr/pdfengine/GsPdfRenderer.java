...
public class GsPdfRenderer {
    ...
    public GsPdfRenderer(GreensheetForm form, GsGrant grant, String commentOption, String commentOptionSepPage, String generateAllQuestions) {
        this.form = form;
        this.grant = grant;
    ...
    public byte[] generatePdf()throws GreensheetBaseException {
        ...
        try {
            ...
            if (form.getGroupType().equals(GreensheetGroupType.PGM)
                ...
                form.getGroupType().equals(GreensheetGroupType.SPEC)
                    && grant.getType().equalsIgnoreCase("5")
                    || grant.getType().equalsIgnoreCase("8")
                    || grant.getType().equalsIgnoreCase("4")) {
            ...
            File questSrc = (File) AppConfigProperties.getInstance().getProperty(srcKey);
    ...
    private Document generateGsFormXml(Document doc) throws Exception {
        ...
        File xsltSrc = (File) AppConfigProperties.getInstance().getProperty("FORM_XML_TRANSLATOR");
    ...
    private void generatePdfReadyXml(Document doc) {
        ...
        Element additionalInfoElm = doc.getRootElement().addElement("AdditionalInfo");
        Element generateAllQuestions = additionalInfoElm.addElement("DisplayAllQuestions");
        ...
        Element commentOptionSepPage = additionalInfoElm.addElement("CommentOptionSeperatePage");
        ...
        Element primarySpecialist = additionalInfoElm.addElement("PrimarySpecialist");
        ...
        Element programDirector = additionalInfoElm.addElement("ProgramDirector");
        programDirector.addText(grant.getPdName());
        Element backUpSpecialist = additionalInfoElm.addElement("BackUpSpecialist");
        ...
        for (Iterator iter = list.iterator(); iter.hasNext();) {
            ...
            logger.debug("respDefId " + respDefId + "respDefType " + respDefType);
            ...
            if (respDefType.equalsIgnoreCase("TEXT")
                ...
                respDefType.equalsIgnoreCase("RADIO")
                ...
                for (Iterator iter2 = selList.iterator(); iter2.hasNext();) {
                    ...
                    if (qrd != null) {
                        ...
                        if (selVal.equalsIgnoreCase(selDefId) && !type.equalsIgnoreCase(QuestionResponseData.CHECK_BOX)) {
                            userElm.addText("YES");

                        } else if (!selVal.equalsIgnoreCase(selDefId) && !type.equalsIgnoreCase(QuestionResponseData.CHECK_BOX)) {
                            userElm.addText("NO");
    ...
    private void printXmlFile(String fileName, Document document) throws Exception {
