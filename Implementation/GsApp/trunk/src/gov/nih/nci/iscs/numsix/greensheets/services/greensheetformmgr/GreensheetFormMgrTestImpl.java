...
public class GreensheetFormMgrTestImpl implements GreensheetFormMgr {
    ...
    private static final Logger logger = Logger.getLogger(GreensheetFormMgrTestImpl.class);
    /**
     * @see gov.nih.nci.iscs.numsix.greensheets.services.greensheetformmgr.GreensheetFormMgr#getGreensheetFormAnswers(GreensheetForm)
     */
    public void getGreensheetFormAnswers(GreensheetForm gsform) throws GreensheetBaseException {

//        Map map = new HashMap();
//
//        QuestionResponseData qrd1 = new QuestionResponseData();
//        qrd1.setSelectResponseData("TESTQ_1", "TESTQ_1_RD_DD_3", QuestionResponseData.DROP_DOWN, "SEL_2");
//
//        QuestionResponseData qrd2 = new QuestionResponseData();
//        qrd2.setSelectResponseData("TESTQ_9", "TESTQ_9_RD_CB_27", QuestionResponseData.CHECK_BOX, ",SEL_12,SEL_14,");
//
//        QuestionResponseData qrd3 = new QuestionResponseData();
//        qrd3.setInputResponseData("TESTQ_10", "TESTQ_10_RD_ST_29", QuestionResponseData.STRING, "Hello World Again");
//
...
//
//        qrd4.setFileResponseData("TESTQ_1", "TESTQ_1_RD_FL_2", QuestionResponseData.FILE, qa);
//
...
//        qrd5.setInputResponseData("TESTQ_1", "TESTQ_3_RD_DT_9", QuestionResponseData.DATE, "12/12/2002");
//
//        QuestionResponseData qrd6 = new QuestionResponseData();
//        qrd6.setInputResponseData("TESTQ_1", "TESTQ_4_RD_TX_12", QuestionResponseData.DATE, "This is some text for a text \n box");
//
...
//        gsform.setQuestionResponsDataMap(map);
     ...
     */
    public GreensheetForm findGreensheetForGrant(GsGrant grant, GreensheetGroupType type) throws GreensheetBaseException {

        GreensheetForm pgmForm = new GreensheetForm();

//        pgmForm.setGroupType(type);
//        pgmForm.setStatus(GreensheetStatus.NOT_STARTED);
//        String templateId = type.getName() + "_" + grant.getType() + grant.getMech() + "_1";
//
...
//        pgmForm.setTemplateId(templateId);
     ...
     */
    public void saveForm(GreensheetForm form, Map newVals, GsUser user, GsGrant grant) throws GreensheetBaseException {
...
//        form.setStatus(GreensheetStatus.SAVED);
     ...
     */
    public void submitForm(GreensheetForm form, Map newVals, GsUser user, GsGrant grant) throws GreensheetBaseException {
        this.saveForm(form, newVals, user, grant);

    }

    private void setAnswerResponseValues(Map questionResponseDataMap, Map newValues) {
        ...
        while (iter.hasNext()) {
            ...
            if (questionResponseDataMap.containsKey(key)) {
                ...
                if (qrd.getInputValue() != null && !qrd.getInputValue().equalsIgnoreCase(value)) {
                    qrd.setInputValue(value);
                } else if (qrd.getSelectionDefId() != null && !qrd.getSelectionDefId().equalsIgnoreCase("," + value + ",")) {
                    qrd.setSelectionDefId(value);
                }

                System.out.println("Existing qid:" + qrd.getQuestionDefId() + "  key: " + key + "  value: " + value);
                ...
                if (key.indexOf("_DD_") > -1) {
                    qrd.setSelectResponseData(questionDefId, key, QuestionResponseData.DROP_DOWN, value);
                } else if (key.indexOf("_RB_") > -1) {
                    qrd.setSelectResponseData(questionDefId, key, QuestionResponseData.RADIO, value);
                } else if (key.indexOf("_CB_") > -1) {
                    value = "," + value + ",";
                    qrd.setSelectResponseData(questionDefId, key, QuestionResponseData.CHECK_BOX, value);
                } else if (key.indexOf("_TX_") > -1) {
                    qrd.setInputResponseData(questionDefId, key, QuestionResponseData.TEXT, value);
                } else if (key.indexOf("_NU_") > -1) {
                    qrd.setInputResponseData(questionDefId, key, QuestionResponseData.NUMBER, value);
                } else if (key.indexOf("_ST_") > -1) {
                    qrd.setInputResponseData(questionDefId, key, QuestionResponseData.STRING, value);
                } else if (key.indexOf("_DT_") > -1) {
                    qrd.setInputResponseData(questionDefId, key, QuestionResponseData.DATE, value);
                } else if (key.indexOf("_FL_") > -1) {
                    qrd.setInputResponseData(questionDefId, key, QuestionResponseData.FILE, value);
                } else if (key.indexOf("_CM_") > -1) {
                    qrd.setInputResponseData(questionDefId, key, QuestionResponseData.COMMENT, value);
                }

                questionResponseDataMap.put(key, qrd);

                System.out.println("New qid:" + qrd.getQuestionDefId() + "  key: " + key + "  value: " + value);
            }
    ...
    /**
                 ...
                 */
    public void changeLock(GreensheetForm form, GsUser user) throws GreensheetBaseException {
...
//        }
    ...
    /**
              ...
              */
    public GreensheetForm findGreensheetFormByGrantNumber(String grantNumber) throws GreensheetBaseException {
...
//        pgmForm.setTemplateId(templateId);
     ...
     */
    public void getQuestionAttachmentData(QuestionAttachment qa) throws GreensheetBaseException {
        AttachmentHelper ah = new AttachmentHelper();
     ...
     */
    public byte[] getGreensheetFormAsPdf(GreensheetForm form, GsGrant grant, String commentOption, String commentOptionSepPage,String generateAllQuestions)throws GreensheetBaseException {
        GsPdfRenderer rend = new GsPdfRenderer(form, grant, commentOption, commentOptionSepPage,generateAllQuestions);
