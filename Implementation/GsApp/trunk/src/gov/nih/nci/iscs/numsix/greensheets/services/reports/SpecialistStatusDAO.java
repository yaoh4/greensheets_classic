...
public class SpecialistStatusDAO {
    ...
    private static final Logger logger = Logger.getLogger(SpecialistStatusDAO.class);
    ...
    public static List getSpecialistStatusData() throws GreensheetBaseException{
        ...
        try {
            ...
            String sql = 
                "select fv.full_grant_num, fv.appl_Id, ft.submitted_user_id, ft.submitted_date" 
