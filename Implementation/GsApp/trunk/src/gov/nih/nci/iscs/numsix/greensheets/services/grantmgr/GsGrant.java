...
public class GsGrant {
    ...
    public String getPdName() {
        ...
        if (formGrant.getPdLastName() == null || formGrant.getPdFirstName() == null) {
            return "";
        } else {
    ...
    public String getPrimarySpecialist() {
        ...
        if (formGrant.getGmsLastName() == null || formGrant.getGmsFirstName() == null) {
            return "";
        } else {
            return formGrant.getGmsLastName() + "," + formGrant.getGmsFirstName();
        }
    }
    ...
    /**
     * Sets the formGrant.
     * @param formGrant The formGrant to set
     */
