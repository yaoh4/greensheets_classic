...
public class EmailNotification {
    ...
    public static void sendEmailNotification(String message, HttpServletRequest req) {

        if (sendEmail != null) {
            if (!Boolean.parseBoolean(sendEmail))
                return;
            if (from == null || to == null || host == null || environment == null) {
                logger.error("!! *  Properties for sending e-mail notifications are not set correclty.");
                return;
            }
        }
