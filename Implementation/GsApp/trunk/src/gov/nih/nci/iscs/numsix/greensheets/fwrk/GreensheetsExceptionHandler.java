...
/**
 * Exception Handler for GreensheetBaseExceptions allows handeling of nested
 * exceptions
 * 
 * 
...
public class GreensheetsExceptionHandler extends ExceptionHandler {
	...
	/**
	 * @see org.apache.struts.action.ExceptionHandler#storeException(HttpServletRequest,
	 *      String, ActionError, ActionForward, String)
	 */
