...
public class QuestionAttachment {
	...
	private static final int DELETED = 2; // indicates that the attachment has
	 ...
	 */
	public static QuestionAttachment createExistingAttachment(String filename,
			String path, int id) {
		logger
				.debug("In Method QuestionAttachment:createExistingAttachment().");
