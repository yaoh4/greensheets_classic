...
import gov.nih.nci.iscs.numsix.greensheets.services.greensheetresourcemgr.GreensheetResourceDraftManagerImpl;
...
/**
 * Created by IntelliJ IDEA. User: Jed Date: Sep 7, 2003 Time: 12:53:26 PM To change this template use Options | File Templates.
 */
public class GreenSheetDraftResourceLoader extends
    ...
    private GreensheetResourceManager gsMgr = new GreensheetResourceDraftManagerImpl(); // For time being -- Abdul Latheef
    ...
    public InputStream getResourceStream(String s)
        ...
        System.out.println(" @@@@@@@@@@@@@ this is draft resource");
        String tmplStr = null;
