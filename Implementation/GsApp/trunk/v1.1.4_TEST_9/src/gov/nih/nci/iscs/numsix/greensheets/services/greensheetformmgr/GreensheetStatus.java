...
public class GreensheetStatus extends ValuedEnum  {
    ...
    public static final GreensheetStatus NOT_STARTED = new GreensheetStatus("NOT_STARTED", NOT_STARTED_VALUE);
    public static final GreensheetStatus FROZEN = new GreensheetStatus("FROZEN", FROZEN_VALUE);
    public static final GreensheetStatus SAVED = new GreensheetStatus("SAVED", SAVED_VALUE);
    public static final GreensheetStatus SUBMITTED = new GreensheetStatus("SUBMITTED", SUBMITTED_VALUE);
    public static final GreensheetStatus UNSUBMITTED = new GreensheetStatus("UNSUBMITTED", UNSUBMITTED_VALUE);
