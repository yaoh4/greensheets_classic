...
public class GrantGreensheetProxy{
    ...
    private static final Logger logger = Logger.getLogger(GrantGreensheetProxy.class);
    ...
    public String getGrantNumberSort() {
        ...
        String value =
            "<a href=\"javascript:getGrantDetail('"
                + getGrantNumber()
                + "',"
                + "'"
                + grant.getApplId()
    ...
    public String getProgramLockIcon() {
        ...
        if (grant.getProgramFormStatus().equalsIgnoreCase(GreensheetStatus.UNSUBMITTED.getName())) {
            lockIcon = "IconUnlocked.gif";
        } else if (grant.getProgramFormStatus().equalsIgnoreCase(GreensheetStatus.SUBMITTED.getName())) {
    ...
    public String getSpecialistLockIcon() {
        String lockIcon = null;
        if (grant.getSpecialistFormStatus().equalsIgnoreCase(GreensheetStatus.UNSUBMITTED.getName())) {
            lockIcon = "IconUnlocked.gif";
        } else if (grant.getSpecialistFormStatus().equalsIgnoreCase(GreensheetStatus.SUBMITTED.getName())) {
            lockIcon = "IconLocked.gif";
        } else {
            lockIcon = "IconNoLocking.gif";
        }
     ...
     * @param userOracleId The userOracleId to set
     */
    ...
    private String setGreensheetString(String group) {
        String value =
            "<a href=\"javascript:retreieveGreensheet('"
                + grant.getFullGrantNumber()
                + "','"
                + this.getApplId()
                + "','"
