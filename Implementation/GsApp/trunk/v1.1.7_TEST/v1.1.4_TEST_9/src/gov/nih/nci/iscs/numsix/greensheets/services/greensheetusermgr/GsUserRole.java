...
/**
 *  Enumeration of the different user roles that a user of the application my have.
 * 
 * 
...
public class GsUserRole extends ValuedEnum {
    ...
    public static final GsUserRole PGM_DIR = new GsUserRole("PGM_DIR", PGM_DIR_VALUE);
    public static final GsUserRole PGM_ANL = new GsUserRole("PGM_ANL", PGM_ANL_VALUE);
    public static final GsUserRole RMC_QA = new GsUserRole("RMC_QA", RMC_QA_VALUE);
    ...
    public static final GsUserRole GS_GUEST = new GsUserRole("GS_GUEST", GS_GUEST_VALUE);
    public static final GsUserRole NO_SYSTEM_ROLE = new GsUserRole("NO_SYSTEM_ROLE", NO_SYSTEM_ROLE_VALUE);        
