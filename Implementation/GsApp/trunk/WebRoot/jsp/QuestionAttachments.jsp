...
<script>
  ...
  function removeAttach(filename) {
    ...
    var bool = confirm("Are you sure you want to Delete " + filename + "?");
    if (bool) {
  		document.attachmentsForm.deleteFileName.value = filename;
  ...
  function viewAttach(filename) {
  		document.attachmentsForm.viewFileName.value = filename;
...
<html:form action="questionattachments" enctype="multipart/form-data">
	...
	<html:hidden name="attachmentsForm" property="deleteFileName"/>
	<html:hidden name="attachmentsForm" property="viewFileName"/> 
	...
	<table width="100%" cellspacing="0" class="data">
		...
		<logic:iterate id="attachment" name="TMP_ATTTACHMENTS_LIST" property="tmpQuestionAttachmentList">                			
	  <tr> 
	  	<td>
	    	<a href="javascript:viewAttach('<bean:write name="attachment" property="filename"/>')"><img src="./images/IconView.gif" alt="View" width="15" height="15" border="0" /></a>
        <logic:equal name="canEdit" value="true">
            <a href="javascript:removeAttach('<bean:write name="attachment" property="filename"/>')" ><img src="./images/IconDelete.gif" alt="Delete" width="15" height="15" border="0" /></a> 
        </logic:equal>	    
