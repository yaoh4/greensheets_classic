...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:variable name="varImagePath">
        <xsl:choose>
            <xsl:when test="$paramGenerateVelocityStrings = 'true' ">./</xsl:when>
            <xsl:when test="$paramGenerateVelocityStrings = 'false' ">../</xsl:when>
        </xsl:choose>
    </xsl:variable>
...
<table width="100%" cellspacing="0" id="GreensheetLabel">
    ...
    <tr>
        <td colspan="3">
            <span class="TitlePrimary">$!CURRENT_USER_SESSION.getGreensheetForm($!FORM_UID).getFormName()</span>
            <br/>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <a href="javascript:getGrantDetail('$!CURRENT_USER_SESSION.getFormSessionGrant($!FORM_UID).getFullGrantNumber()','$!CURRENT_USER_SESSION.getFormSessionGrant($!FORM_UID).getApplId()','$!grantDetailUrl');">$!CURRENT_USER_SESSION.getFormSessionGrant($!FORM_UID).getFullGrantNumber() </a>
        </td>
        <td>
        ...
        <td width="50%"><strong>PI:</strong> $!CURRENT_USER_SESSION.getFormSessionGrant($!FORM_UID).getPi()</td>
    </tr>
    <tr>
        <td width="50%"><strong>Submitter:</strong> $!CURRENT_USER_SESSION.getGreensheetForm($!FORM_UID).getSubmittedBy()</td>
        <td>
            <xsl:call-template name="InsertTab"/>
        </td>
        <td width="50%"><strong>Last Changed By:</strong> $!CURRENT_USER_SESSION.getGreensheetForm($!FORM_UID).getChangedBy()</td>
    </tr>
    <tr>
        <td width="50%"><strong>Institution:</strong> $!CURRENT_USER_SESSION.getFormSessionGrant($!FORM_UID).getOrgName()</td>
        <td>
            <xsl:call-template name="InsertTab"/>
        </td>
        <td width="50%"><strong>Program Director:</strong> $!CURRENT_USER_SESSION.getFormSessionGrant($!FORM_UID).getPdName()</td>
    </tr>
    <tr>
        <td width="50%"><strong>Primary Specialist:</strong> $!CURRENT_USER_SESSION.getFormSessionGrant($!FORM_UID).getPrimarySpecialist()</td>
        <td>
            <xsl:call-template name="InsertTab"/>
        </td>
        <td width="50%"><strong>Backup Specialist:</strong> $!CURRENT_USER_SESSION.getFormSessionGrant($!FORM_UID).getBackupSpecialist()</td>
    </tr>
    <xsl:if test="$paramGenerateVelocityStrings = 'true' ">
        <xsl:text>#if($displayGmsAndPdCode)</xsl:text>
    </xsl:if>
    <tr>
        <td width="50%"><strong>Specialist Code:</strong> $!CURRENT_USER_SESSION.getFormSessionGrant($!FORM_UID).getPrimarySpecialistCode()</td>
        <td>
            <xsl:call-template name="InsertTab"/>
        </td>
        <td width="50%"><strong>Program Director Code:</strong> $!CURRENT_USER_SESSION.getFormSessionGrant($!FORM_UID).getPdCode()</td>
    </tr>
    <xsl:if test="$paramGenerateVelocityStrings = 'true' ">
    ...
    <tr>
        <td width="50%"><strong>Status:</strong>  $!CURRENT_USER_SESSION.getGreensheetForm($!FORM_UID).getStatusAsString()</td>
        <td>
            <xsl:call-template name="InsertTab"/>
        </td>
        
        <td width="50%"><strong>Submitted Date:</strong> $!CURRENT_USER_SESSION.getGreensheetForm($!FORM_UID).getSubmittedDateAsString()</td>
    ...
    <tr>
        <td width="50%"><strong>POC:</strong><xsl:text disable-output-escaping="yes">&lt;input type="text" name="pointOfContact" id="pointOfContact" value="$!CURRENT_USER_SESSION.getGreensheetForm($!FORM_UID).getPOC()" $!disablePoc /&gt;</xsl:text>
        </td>
        <td>
            <xsl:call-template name="InsertTab"/>
        </td>
...
<xsl:template name="DisplayClearAllButton">
    <xsl:text>#if($!displaySave)</xsl:text>
...
<xsl:template name="DisplaySubmitButton">
    <xsl:text>#if($!displaySubmit)</xsl:text>
    ...
    <xsl:template name="DisplayCommentIcon">
        ...
        <a>
            ...
            <img width="16" height="16" border="0">             
                <xsl:attribute name="src"><xsl:value-of select="$varImagePath"/>#if($<xsl:value-of select="$pCommentId"/>.commentHasValues())images/IconCommentChecked.gif#end#if(!$<xsl:value-of select="$pCommentId"/>.commentHasValues())images/IconComment.gif#end</xsl:attribute>
    ...
    <xsl:template name="DisplayFileIcon">
        ...
        <span valign="middle">
            <a>
                ...
                <img width="16" height="16" border="0"> 
                    <xsl:attribute name="src"><xsl:value-of select="$varImagePath"/>#if($<xsl:value-of select="$varResponseDefId"/>.hasQuestionAttachments())images/IconAttachmentChecked.gif#end#if(!$<xsl:value-of select="$varResponseDefId"/>.hasQuestionAttachments())images/IconAttachment.gif#end</xsl:attribute>
