...
public class DocChecker {
	...
	public static void main(String[] args) throws DocCheckerException {
...
//			System.err.println(exp.toString());
			exp.printStackTrace();
			log.error("Error running the DocChecker application: " + exp.getMessage());
			System.exit(-1);
		}
		log.debug("Exiting the Greensheets Document Checker application.");
	}
