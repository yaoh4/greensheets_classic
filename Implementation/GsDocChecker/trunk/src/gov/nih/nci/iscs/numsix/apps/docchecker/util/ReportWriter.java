...
public class ReportWriter extends PdfPageEventHelper {
    ...
    public static final Logger log = Logger.getLogger(ReportWriter.class);
	...
	public void writeToPdf(DocCheckerResults docCheckerResults, String fileName) throws DocCheckerException {
		...
		docCheckerResultsMapActionNone = docCheckerResults.getDocCheckerResultsMapActionNone();
		docCheckerResultsMapActionReconcile = docCheckerResults.getDocCheckerResultsMapActionReconcile();
		docCheckerResultsMapActionLocate = docCheckerResults.getDocCheckerResultsMapActionLocate();		
...
//			cell.setHorizontalAlignment(Element.ALIGN_CENTER);
	...
	//			float[] widths = {0.52f, 0.7f, 0.7f, 0.7f, 0.7f, 0.20f};
				...
				prepareTable(docCheckerResultsMapActionLocate, table);
				prepareTable(docCheckerResultsMapActionReconcile, table);
				prepareTable(docCheckerResultsMapActionNone, table);
    ...
    private void prepareTable(Map docCheckerResultsMap, PdfPTable table) {
