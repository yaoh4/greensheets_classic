...
public class EmailManager {
	...
	public static final Logger log = Logger.getLogger(EmailManager.class);
	...
	public int sendFile(List emailRecipients, String sender, String subject, String message, String fileName) throws DocCheckerException {
		...
		if (this.smtpServer == null ||
			...
			log.error("args to sendFile() method are incorrect.");
//			return IConstants.FAILURE;
		...
		try {
			...
			log.error("Exception occurred inside the sendFile() method." + mex.getMessage());
			mex.printStackTrace();
			Exception ex = null;
