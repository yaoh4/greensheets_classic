...
public class AppManager {
	public static Logger log = Logger.getLogger("gov.nih.nci.iscs.numsix.apps.docchecker.AppManager");
	...
	public void init() throws DocCheckerException {
		...
		try {
			log.debug("Initializing the application configuration information from the files.");
...
//			System.out.println(cex.getMessage());
	...
	public int emailReport(String reportFileName) throws DocCheckerException {
		log.debug("Calling sendFile() method from the AppManager.");
